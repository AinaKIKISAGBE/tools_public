...
cp /myapp/tools_private/vm_provitionning/worker_docker/docker/Dockerfile_provision_worker_docker.sh  Dockerfile_provision_worker_docker.sh 
chmod +x Dockerfile_provision_worker_docker.sh 

bash /Dockerfile_provision_worker_docker.sh
